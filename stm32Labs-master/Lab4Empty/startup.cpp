...
const tIntVectItem __vector_table[] =
{
  ...
  InterruptHandler::DummyHandler,        ////TIM4 37
  InterruptHandler::DummyHandler,        //I2C1_EV 38
  InterruptHandler::DummyHandler,        //I2C1_ER 39
  InterruptHandler::DummyHandler,        //I2C2_EV 40
  InterruptHandler::DummyHandler,        // I2C2_ER 41
  InterruptHandler::DummyHandler,        //SPI1 42
  InterruptHandler::DummyHandler,        // SPI2 43
  InterruptHandler::DummyHandler,        // USART1 44 
  InterruptHandler::DummyHandler,        //USART2 45
  0, //46
  InterruptHandler::DummyHandler,        //EXTI15_10 47
  InterruptHandler::DummyHandler,        //EXTI17 / RTC_Alarm E 48
  InterruptHandler::DummyHandler,        //EXTI18 /OTG_FS_WKUP 49
    0, //50
      0, //51 
        0, //52
          0, //53
  InterruptHandler::DummyHandler,        //DMA1_Stream7 /54
  0, //55
